  ...
  "properties": [
    {
      ...
      "status": "unlocked",
      "value": {
        "asset_ref": "Assets/FILE/%23FILE%3Aindex.html",
        "file_type_ref": "html",
        "properties": {}
      }
    },
    {
      "id": "DATA_PAGE_REQUEST",
      "property_type_ref": "data",
      "ruleset_ref": "RULESET_DATA",
      "status": "unlocked",
      "value": {
        "data_type_ref": "page_request",
        "value": null,
        "schema_ref": {
          "entity_ref": "#CTRCT:UltralightCMS:PageRequest",
          "property_ref": "SCHEMA_PAGE_REQUEST"
        },
        "properties": {}
      }
    },
    {
      "id": "DATA_INDEX_DOCUMENT",
      "property_type_ref": "data",
      "ruleset_ref": "RULESET_DATA",
      "status": "unlocked",
      "value": {
    ...
    },
    {
      ...
      "status": "unlocked",
      "value": {
        "event_type_ref": "open_page",
        "properties": {}
      }
    },
    {
      "id": "FUNCTION_OPEN_PAGE",
      "property_type_ref": "function",
      "ruleset_ref": "RULESET_FUNCTION",
      "status": "unlocked",
      "value": {
        "function_type_ref": "open_page",
        "input_refs": [],
        "output_refs": [],
        "logic": {
          ...
          "body": [
            {
              "op": "emit",
              "cause_ref": "LINK_OPEN_PAGE_CAUSES_RENDER_PAGE"
            },
            {
              "op": "return"
            }
    ...
    {
      "id": "LINK_PAGE_REQUEST_INPUT",
      "property_type_ref": "link",
      "ruleset_ref": "RULESET_LINK_EVENT_INPUT",
      "status": "unlocked",
      "value": {
        "link_type_ref": "event_input",
        "parent_ref": "DATA_PAGE_REQUEST",
        "child_ref": "EVENT_OPEN_PAGE",
        "properties": {}
      }
    },
    {
      "id": "LINK_OPEN_PAGE_REQUEST_READY",
      "property_type_ref": "link",
    ...
    {
      "id": "LINK_OPEN_PAGE_HANDLER",
      "property_type_ref": "link",
      "ruleset_ref": "RULESET_LINK_EVENT_HANDLER",
      "status": "unlocked",
      "value": {
        "link_type_ref": "event_handler",
        "parent_ref": "EVENT_OPEN_PAGE",
        "child_ref": "FUNCTION_OPEN_PAGE",
        "properties": {}
      }
    },
    {
      "id": "REQ_INDEX_RENDERER",
    ...
    {
      "id": "LINK_INDEX_RENDERER_DEPENDENCY",
      "property_type_ref": "link",
      "ruleset_ref": "RULESET_LINK_DEPENDENCY",
      "status": "unlocked",
      "value": {
        "link_type_ref": "dependency",
        "parent_ref": "#FILE:renderer",
        "child_ref": "#FILE:index",
        "required_link_ref": "REQ_INDEX_RENDERER",
        "properties": {}
      }
    },
    {
      "id": "LINK_OPEN_PAGE_CAUSES_RENDER_PAGE",
      "property_type_ref": "link",
      ...
      "value": {
        ...
        "child_ref": {
          ...
          "property_ref": "EVENT_RENDER_PAGE"
        },
        "properties": {}
      }
    }
